...
def app():
    ...
    sex = sex_mapping[sex]
    height = st.number_input('Height (cm)', value = 1)
    weight = st.number_input('Weight (KG)', value = 1)
    arm_span = st.number_input('Arm Span (cm)', value = 1)
    ...
    max_pullups = st.number_input('Max pull up reps', value = 1) 
