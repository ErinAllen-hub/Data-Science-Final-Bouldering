...
def app():
    ...
    avg_hours_climbing = st.number_input('Average hours climbing per week (not including training)', step = 0.25)
    avg_hours_training = st.number_input('Average hours Training for climbing per week', step = 0.25)
    campus_board_freq = st.number_input('Campus Board frequency per week', step = 1)
    campus_board_time = st.number_input('Campus Board time per week (hours)', step = 0.25)
    endurance_freq = st.number_input('Frequency of Endurance training sessions per week', step = 1)
    strength_freq = st.number_input('General Strength Training frequency per week', step = 1)
